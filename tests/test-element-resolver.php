...
class Test_Element_Resolver extends TestCase {
	...
	public function test_resolve_for_typing_resolves_by_id() {
		...
		$resolver = new Element_Resolver( $driver );
	...
	public function test_format_correctly_formats_selectors() {
		$resolver = new Element_Resolver( new stdClass() );
		$this->assertSame( 'body #modal', $resolver->format( '#modal' ) );

		$resolver = new Element_Resolver( new stdClass(), 'prefix' );
